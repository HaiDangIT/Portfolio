          ...
          <div className="bg-white rounded-2xl p-8 border-2 border-gray-100 shadow-lg">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <a
                ...
                className="flex items-center gap-3 p-4 rounded-xl bg-gray-50 hover:bg-gray-100 transition-all duration-300 border-2 border-transparent hover:border-gray-300 group"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 p-4 rounded-xl bg-blue-50 hover:bg-blue-100 transition-all duration-300 border-2 border-transparent hover:border-blue-300 group"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 p-4 rounded-xl bg-indigo-50 hover:bg-indigo-100 transition-all duration-300 border-2 border-transparent hover:border-indigo-300 group"
              >
                ...
                <span className="font-semibold text-indigo-700 group-hover:text-indigo-900">
                  Discord
                </span>
              </a>
            </div>
