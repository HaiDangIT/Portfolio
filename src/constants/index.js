...
export const certificates = [
  {
    id: 1,
    image: chungchi1,
    title: "Chứng chỉ Networking Basics",
    issuer: "Cisco Networking Academy",
    date: "Tháng 9, 2025",
    description: "Hoàn thành khóa học Networking Basics",
  },
  {
    id: 2,
    image: chungchi2,
    title: "Chứng chỉ Javascript 1",
    issuer: "Cisco Networking Academy",
    date: "Tháng 9, 2025",
    description: "Chứng nhận kỹ năng phát triển với Javascript 1",
  },
  {
    id: 3,
    image: chungchi3,
    title: "Chứng chỉ Javascript 2",
    issuer: "Cisco Networking Academy",
    date: "Tháng 9, 2025",
    description: "Chứng nhận kỹ năng phát triển với Javascript 2",
  },
];
...
export const journey = [
  {
    ...
    description:
      "Bắt đầu học lập trình với HTML, CSS và JavaScript cơ bản. Tạo ra những website đầu tiên và khám phá đam mê với công nghệ.",
    icon: "🚀",
  },
  {
    year: "2023",
    ...
    description:
      "Chuyên sâu vào React, Node.js và PosgreSQL. Hoàn thành nhiều dự án thực tế và nhận được các chứng chỉ chuyên môn.",
    icon: "📚",
  },
  {
    year: "2024",
    ...
    description:
      "Học về kiến trúc hệ thống, microservices và các công nghệ cloud. Tham gia các dự án nhóm và đóng góp cho cộng đồng open-source.",
    icon: "🎯",
  },
  {
    year: "2025",
    ...
    description:
      "Hoàn thiện kỹ năng Backend, học về AI/ML và xây dựng portfolio chuyên nghiệp. Chuẩn bị cho sự nghiệp trong ngành công nghệ.",
    icon: "✨",
  },
];
...
export const hobbies = [
  ...
  {
    title: "Coding & Học Hỏi",
    description:
      "Lập trình không chỉ là công việc mà còn là sở thích. Tôi thích khám phá các công nghệ mới, giải quyết các bài toán thuật toán, đóng góp cho open-source và xây dựng các side projects sáng tạo.",
    icon: "💻",
...
export const goals = [
  {
    ...
    items: [
      "Hoàn thành xuất sắc chương trình đại học với GPA cao",
      "Trở thành Backend Developer thành thạo với React, Node.js, và cloud technologies",
      "Đóng góp tích cực vào các dự án open-source lớn",
      "Xây dựng portfolio với ít nhất 5 dự án thực tế có giá trị",
    ],
    icon: "🎯",
  },
  {
    title: "Dài hạn (3-5 năm)",
    items: [
      "Trở thành Senior Software Engineer tại công ty công nghệ hàng đầu",
      "Chuyên sâu về kiến trúc hệ thống phân tán và microservices",
      "Học và ứng dụng AI/Machine Learning vào các sản phẩm thực tế",
      "Chia sẻ kiến thức qua blog, YouTube và các buổi tech talk",
      "Khởi nghiệp hoặc tham gia xây dựng startup công nghệ",
    ],
    icon: "🚀",
  },
];
...
export const projects = [
  {
    ...
    name: "SkillCoder",
    description:
      "Nền tảng học lập trình trực tuyến với khóa học đa dạng, bài tập tương tác, video lessons và forum thảo luận.",
  ...
  },
  {
    ...
    description:
      "Ứng dụng kết nối người cho thuê và tìm phòng. Tích hợp tìm kiếm, Google Maps, chat real-time và quản lý đặt phòng.",
  ...
  },
  {
    ...
    description:
      "Website portfolio hiện đại với 3D animations và interactive UI. Sử dụng Three.js cho hiệu ứng 3D đẹp mắt.",
  ...
  },
  {
    ...
    description:
      "Hệ thống quản lý trường học với quản lý thông tin sinh viên, điểm số, lịch học, điểm danh và thống kê báo cáo.",
  ...
  },
  {
    ...
    description:
      "Ứng dụng streaming nhạc với player tùy chỉnh, playlist cá nhân, lyrics display và audio visualization.",
  ...
  },
  {
    ...
    description:
      "Game roguelike 2D với procedural generation, combat system, inventory, skill tree và random dungeon. Mỗi lần chơi là một trải nghiệm mới.",
...
Đầu tư học Java = Đầu tư cho sự nghiệp! 🚀
  ...
  {
    id: 2,
    title: "Spring Boot: Framework Java hiện đại cho Microservices",
    excerpt:
      "Tìm hiểu về Spring Boot - framework mạnh mẽ giúp xây dựng ứng dụng Java nhanh chóng và hiệu quả. Khám phá các tính năng auto-configuration và dependency injection.",
    content: `
...
Happy Spring Boot coding! 🚀
  ...
  },
  {
    ...
    excerpt:
      "So sánh chi tiết giữa ArrayList và LinkedList trong Java. Khi nào nên dùng cái nào? Phân tích performance và use cases thực tế.",
    content: `
...
Happy coding with the right List! 🎯
  ...
  {
    id: 4,
    title: "JVM Memory Management và Garbage Collection",
    excerpt:
      "Hiểu sâu về cách JVM quản lý bộ nhớ. Tìm hiểu về Heap, Stack, Garbage Collection algorithms và cách tối ưu hóa performance.",
    content: `
...
**Remember:** Hiểu JVM = Code Java như pro! 🚀
  ...
  {
    id: 5,
    title: "JavaScript ES6+: Tính năng hiện đại bạn cần biết",
    excerpt:
      "Khám phá các tính năng mới trong ES6+ như Arrow Functions, Destructuring, Spread Operator, Promises và Async/Await. Nâng cao kỹ năng JavaScript của bạn.",
    content: `
...
Master ES6+ = Master Modern Web Development! 🎯
  ...
  {
    id: 6,
    title: "React Hooks: useState và useEffect cho người mới bắt đầu",
    excerpt:
      "Hướng dẫn chi tiết về React Hooks. Cách sử dụng useState để quản lý state và useEffect để xử lý side effects trong functional components.",
    content: `
...
Happy Hooking! 🎣
  ...
  {
    id: 7,
    title: "Node.js Event Loop: Cách hoạt động của bất đồng bộ",
    excerpt:
      "Giải thích chi tiết về Event Loop trong Node.js. Hiểu rõ Call Stack, Callback Queue, và cách Node.js xử lý I/O operations.",
    content: `
...
Event Loop = Node.js Superpower! ⚡
  ...
  {
    id: 8,
    title: "TypeScript: Tại sao bạn nên sử dụng trong dự án JavaScript",
    excerpt:
      "Khám phá lợi ích của TypeScript - JavaScript với type safety. Cải thiện code quality và developer experience với static typing.",
    content: `
...
TypeScript = **Better JavaScript** for serious projects! 🎯
  ...
  {
    id: 9,
    title: "Java vs JavaScript: So sánh chi tiết và khi nào nên dùng",
    excerpt:
      "Phân tích sâu sắc sự khác biệt giữa Java và JavaScript. Từ syntax, ecosystem đến use cases. Giúp bạn chọn ngôn ngữ phù hợp cho dự án.",
    content: `
